<template>
	...
	<!-- <div id="unity-container">
	    <iframe src="assets/UnityWebGL/index.html" style="width: 100%; height: 100%; border: none;"></iframe>
	</div> -->
	</div>
	...
	.main {
		...
		//  justify-content: space-around;
			...
			.talk {
				...
				padding: 5rpx;
				margin-left: -40%;
				border: 3rpx solid #C7DEF5;
				border-radius: 10rpx;
				z-index: 10;
				background-color: rgba(37,90,139,0.4);
				color: white;
			...
			.body {
				background-image: url('../../../static/back/back/background.jpg');
